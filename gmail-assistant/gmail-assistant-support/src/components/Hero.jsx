...
const Hero = () => {
    return <>
        ...
        <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-24 dark:text-gray-400">Turbocharge your Gmail! Our AI agent scans new emails, instantly zapping important emails to the right team - all while you sip your coffee.</p>
        <WorkingFlow />
        <div className="my-10">
