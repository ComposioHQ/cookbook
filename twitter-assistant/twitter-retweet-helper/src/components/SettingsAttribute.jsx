...
const SettingsAttribute = ({ type, displayName, value, linkAction, loading, buttonName="Link", showButton=true, textArea=false, onChangeFunction, readOnly=true, nolabel=false, placeholder="" }) => {
    return <div className={`flex items-center gap-4 ${nolabel ? 'w-full' : ''}`}>
