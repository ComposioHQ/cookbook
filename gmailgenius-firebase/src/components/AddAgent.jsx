...
const AddAgent = ({ user }) => {
    ...
    const handleFetch = async (e) => {
        e.preventDefault();
        try {
            await updateUserKeywordsAndAttributes(user.uid, emailKeywords, attributes);
        } catch (error) {
    ...
    return (
        <form onSubmit={handleFetch} className="min-h-screen max-w-sm mx-auto my-16">
            <div className="mb-10">
